...
<body class="nk-body">
  ...
  <div class="alert alert-info alert-dismissible fade show" role="alert">
    For more up-to-date data <strong><a class="alert-link"
        href="/assets/pdfs/AMC REQUISITIONED HOSPITAL STATUS 28-04-2021 9.30 AM  ONLINE.pdf"
        download="/assets/pdfs/AMC REQUISITIONED HOSPITAL STATUS 28-04-2021 9.30 AM  ONLINE.pdf">Download
        PDF</a>.</strong>
    ...
    <div class="container-lg">
      ...
      <div class="d-grid gap-2 col-12 mx-auto mt-3">
        ...
        <a class="btn btn-success btn-sm float-right border-reset"
          href="/assets/pdfs/AMC REQUISITIONED HOSPITAL STATUS 28-04-2021 9.30 AM  ONLINE.pdf"
          download="/assets/pdfs/AMC REQUISITIONED HOSPITAL STATUS 28-04-2021 9.30 AM  ONLINE.pdf"><i

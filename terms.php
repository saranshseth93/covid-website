...
<body class="nk-body">
  ...
  <div class="nk-banner">
    <div class="container-lg">
      <div class="row">
        <h3 class="display">Disclamer/Terms of Service</h3><br /><br />
      </div>
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">Interpretation</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          ...
          <ul>
            ...
            <li><strong>Website</strong> gets the data from multiple sources like covidamd.com, ahna.org.in,
              www.gujaratcovidsupport.org and other sources from social media</li>
          </ul>
          </p>
        </div>
      </div><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">Disclaimer</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">External Links Disclaimer</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">Errors and Omissions Disclaimer</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">Fair Use Disclaimer</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">Views Expressed Disclaimer</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">No Responsibility Disclaimer</h4><br />
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          <h4 class="title">"Use at Your Own Risk" Disclaimer</h4><br />
          ...
          <p>The Company will not be liable to You or anyone else for any decision made or action taken in reliance on
            the information given by the Service or for any consequential, special or similar damages, even if advised
      ...
      <div class="col-lg-auto">
        <div class="text-block">
          ...
          <p>By email: <a href="mailto:support@covidmadad.com">support@covidmadad.com</a></p>
        </div>
      </div><br />
